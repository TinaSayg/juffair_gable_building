        ...
        <div class="col-12">
            <div class="col-12">
                <div class="card" style="padding:15px 15px">
                    <form action="{{ route('units.apartment_by_floor.list') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="form-group col-md-6" style="margin-top: 1.90rem !important;">
                                <label for="">Floor Number</label>
                                <input type="text" autocomplete="off" name="search" placeholder="e.g 10" class="form-control">
                            </div>
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        @foreach($units as $unit)
                            ...
                            <tr @if($user_type == 'officer') style="cursor: pointer" class='clickable-row' data-href='{{route('units.apartment_by_floor.show', $unit->id)}}' @endif>
