...
<head>
    ...
    <style>
        ...
        .peoples-visit .visit-caption{
            padding: 0px 11px 147px 63px !important;
        }
            ...
            <div class="container">
                ...
                <div class="section-body">
                                ...
                                <div class="card-body">
                                    <ul class="orderedlist">
                                        ...
                                        <li>Sustainable design with a proper balance of aesthetics, accessibility,
                                            cost-effectiveness, safety, and security</li>
                            ...
                            <div class="row" id="category">
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="single-cat text-center mb-50">
                                        ...
                                        <div class="cat-cap">
                                            <h5><a href="catagori.html">Lobby Reception</a></h5>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="single-cat text-center mb-50">
                                        ...
                                        <div class="cat-cap">
                                            <h5><a href="catagori.html">Outdoor Swimming Pool</a></h5>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="single-cat text-center mb-50">
                                        ...
                                        <div class="cat-cap">
                                            <h5><a href="catagori.html">Indoor Swimming Pool</a></h5>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="single-cat text-center mb-50">
                                        ...
                                        <div class="cat-cap">
                                            <h5><a href="catagori.html">Fitness center</a></h5>
                                ...
                                <div class="col-lg-3 col-md-6 mt-3 col-sm-6">
                                    <div class="single-cat text-center mb-50">
                                        ...
                                        <div class="cat-cap">
                                            <h5><a href="catagori.html">Spa Facilities</a></h5>
                                ...
                                <div class="col-lg-3 col-md-6 mt-3 col-sm-6">
                                    <div class="single-cat text-center mb-50">
                                        ...
                                        <div class="cat-cap">
                                            <h5><a href="catagori.html">High Security Keyless Apartments</a></h5>
                                ...
                                <div class="col-lg-3 col-md-6 mt-3 col-sm-6">
                                    <div class="single-cat text-center mb-50">
                                        ...
                                        <div class="cat-cap">
                                            <h5><a href="catagori.html">European Furniture</a></h5>
                                ...
                                <div class="col-lg-3 col-md-6 mt-3 col-sm-6">
                                    <div class="single-cat text-center mb-50">
                                        ...
                                        <div class="cat-cap">
                                            <h5><a href="catagori.html">BBQ area with outdoor sitting</a></h5>
                    ...
                    <div class="popular-location section-padding30" id="gallery">
                                            ...
                                            <div class="card-body">
                                                <ul class="orderedlist">
                                                    <li>Sustainable design with a proper balance of aesthetics,
                                                        accessibility, safety, and security</li>
                                                    ...
                                                    <li>Multipurpose hall equipped with a TV sitting area, ping pong and
                                                        billiard tables for entertainment and social gatherings </li>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalCenterTitle">Schools Near Juffair Gables</h5>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <ul class="orderedlist check" >
                                            ...
                                            <li><a href="https://goo.gl/maps/cmBzwpzghuhmsRSU7" class="list"  target="_blank"> New Generation Private School</li>
                      ...
                      <div class="modal fade" id="exampleModalCenter1" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalCenterTitle">Shopping Malls near Juffair Gables</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Hospitals and clinics near Juffair Gables</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalCenterTitle">Restaurants & Cafes near Juffair Gables</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                ...
                <div class="modal fade" id="exampleModalCenter5" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalCenterTitle">Park & Beaches near Juffair Gables</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                      ...
                      <div class="modal fade" id="exampleModalCenter6" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalCenterTitle">Digital shops near Juffair Gables</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                      ...
                      <div class="modal fade" id="exampleModalCenter7" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalCenterTitle">Supermarkets near Juffair Gables</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                  ...
                  <div class="modal fade" id="exampleModalCenter8" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalCenterTitle">Petrol Station near Juffair Gables</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Movie Theaters near Juffair Gables</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalCenterTitle">Nursery & Day Care near Juffair Gables</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalCenterTitle">Salons near Juffair Gables</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                  ...
                  <div class="modal fade" id="exampleModalCenter12" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalCenterTitle">Pets Gromming near Juffair Gables</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                    ...
                    <div class="home-blog-area section-padding20" id="apartments">
                        <div class="container">
                            ...
                            <div class="row" id="bedroom">
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                    <div class="single-team mb-30">
                                        <div class="team-img">
                                            <img src="{{ asset('public/assets/img/gallery/303.jpg') }}" alt="">
                                        </div>
                                        <div class="team-caption">
                                            <span>Juffair Gables</span>
                                            <h3><a href="blog.html">Interior Design
                                                </a></h3>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                    <div class="single-team mb-30">
                                        <div class="team-img">
                                            <img src="{{ asset('public/assets/img/gallery/202.jpg') }}" alt="">
                                        </div>
                                        <div class="team-caption">
                                            <span>Juffair Gables</span>
                                            <h3><a href="blog.html">Swimming Pool
                                                </a></h3>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                    <div class="single-team mb-30">
                                        <div class="team-img">
                                            <img src="{{ asset('public/assets/img/gallery/14.jpg') }}" alt="">
                                        </div>
                                        <div class="team-caption">
                                            <span>Juffair Gables</span>
                                            <h3><a href="blog.html">Bedroom
                                                </a></h3>
