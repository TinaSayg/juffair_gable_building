...
<html class="no-js" lang="zxx">
   <head>
      ...
      <style>
         ...
         .card {
            border-radius: 1rem;
            box-shadow: 0px -10px 0px rgb(2, 117, 216)
         }
   ...
   <body>
      ...
      <main>
         <!-- <div class="testimonials">
            <div class="testimonial-inner">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-4 mt-3" style="padding-right: 15px;
                  padding-left: 15px;">
       ...
       <div class="testimonials">
         <div class="section-tittle mt-5 text-center mb-90">
                        <h2>Testimonials</h2>
         </div>
            ...
            <div class="row">
               <div class="col-md-4">
                     <div class="card d-flex mx-auto">
                        <div class="card-image"> <img class="img-fluid d-flex mx-auto " src="https://i.imgur.com/3TlwnLF.jpg" style="width: 6.2rem;border-radius: 5rem;margin: 1.3rem auto 1rem auto;"> </div>
                        <div class="card-text">
               ...
               <div class="col-md-4">
                     <div class="card d-flex mx-auto">
                        <div class="card-image"> <img class="img-fluid d-flex mx-auto" src="https://i.imgur.com/Uz4FjGZ.jpg" style="width: 6.2rem;border-radius: 5rem;margin: 1.3rem auto 1rem auto;"> </div>
                        <div class="card-text">
                           <div class="card-title">Lorem Ipsum!</div> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus Duis leo. Donec sodales sagittis magna
                        </div>
               ...
               <div class="col-md-4">
                     <div class="card d-flex mx-auto ">
                        <div class="card-image"> <img class="img-fluid d-flex mx-auto" src="https://i.imgur.com/udGH5tO.jpg" style="width: 6.2rem;border-radius: 5rem;margin: 1.3rem auto 1rem auto;"> </div>
                        <div class="card-text">
                           <div class="card-title">Lorem Ipsum!</div> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus Duis leo. Donec sodales sagittis magna
                        </div>
